...
inline void InitDefaults() {
  InitDefaultsDualStickRawInputCommandBuffer();
}
}  // namespace protobuf_DualStickRawInputCommandBuffer_2eproto
namespace usx {
...
class DualStickRawInputCommandBuffer : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:usx.geofactions.DualStickRawInputCommandBuffer) */ {
 public:
  ...
  inline DualStickRawInputCommandBuffer* New() const PROTOBUF_FINAL { return New(NULL); }

  DualStickRawInputCommandBuffer* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
 ...
 private:
  ...
  friend void ::protobuf_DualStickRawInputCommandBuffer_2eproto::InitDefaultsDualStickRawInputCommandBufferImpl();
};
// ===================================================================
