...
class DualStickRawInputCommandBuffer PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:usx.geofactions.DualStickRawInputCommandBuffer) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "usx.geofactions.DualStickRawInputCommandBuffer";
  }
  protected:
...
inline void DualStickRawInputCommandBuffer::unsafe_arena_set_allocated_pbv2move(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:usx.geofactions.DualStickRawInputCommandBuffer.pbv2Move)
}
...
inline void DualStickRawInputCommandBuffer::unsafe_arena_set_allocated_pbv2shoot(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:usx.geofactions.DualStickRawInputCommandBuffer.pbv2Shoot)
}
