...
void protobuf_AssignDesc_SecurityCommand_2eproto() {
  protobuf_AddDesc_SecurityCommand_2eproto();
  const ::google::protobuf::FileDescriptor* file =
    ::google::protobuf::DescriptorPool::generated_pool()->FindFileByName(
      "SecurityCommand.proto");
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_SecurityCommand_2eproto);
}
...
void protobuf_ShutdownFile_SecurityCommand_2eproto() {
  delete SecurityCommand::default_instance_;
  delete SecurityCommand_reflection_;
}

void protobuf_AddDesc_SecurityCommand_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\025SecurityCommand.proto\022\007command\"\207\001\n\017Sec"
    "urityCommand\022:\n\004type\030\001 \002(\0162,.command.Sec"
    "urityCommand.SecurityCommandType\022\014\n\004UUID"
    "\030\002 \001(\t\"*\n\023SecurityCommandType\022\010\n\004JOIN\020\000\022"
    "\t\n\005LEAVE\020\001", 170);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "SecurityCommand.proto", &protobuf_RegisterTypes);
  SecurityCommand::default_instance_ = new SecurityCommand();
  SecurityCommand::default_instance_->InitAsDefaultInstance();
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_SecurityCommand_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_SecurityCommand_2eproto {
  StaticDescriptorInitializer_SecurityCommand_2eproto() {
    protobuf_AddDesc_SecurityCommand_2eproto();
  }
} static_descriptor_initializer_SecurityCommand_2eproto_;
...
const SecurityCommand& SecurityCommand::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_SecurityCommand_2eproto();
