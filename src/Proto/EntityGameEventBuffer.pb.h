...
#ifndef PROTOBUF_INCLUDED_EntityGameEventBuffer_2eproto
#define PROTOBUF_INCLUDED_EntityGameEventBuffer_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_EntityGameEventBuffer_2eproto 
...
class EntityGameEventBuffer : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:redhatgamedev.srt.EntityGameEventBuffer) */ {
 public:
  ...
  inline EntityGameEventBuffer* New() const final {
    return CreateMaybeMessage<EntityGameEventBuffer>(NULL);
  }

  EntityGameEventBuffer* New(::google::protobuf::Arena* arena) const final {
...
inline ::box2d::PbBody* EntityGameEventBuffer::mutable_body() {
  set_has_body();
  if (body_ == NULL) {
    auto* p = CreateMaybeMessage<::box2d::PbBody>(GetArenaNoVirtual());
    body_ = p;
  }
...
#endif  // PROTOBUF_INCLUDED_EntityGameEventBuffer_2eproto
